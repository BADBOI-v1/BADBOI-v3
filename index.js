...
say(`Create By VINOR KING\nYOUTUBE : VINOR_KING_Hub\nCountry: Kenya 🇰🇪\nWhatsapp : +254701157072`, {
  font: 'console',
  align: 'center',
  gradient: [randomcolor, randomcolor]
})
    const phoneNumber = await question(`💢 Input your phone number\n<🩸 EXAMPLE : 254701157072\n Number without (+): `);
...
await sleep(30000)
ryoroyko.sendMessage(`254701157072@s.whatsapp.net`, { text: `❗Spider Bot has been connected🌤️

Script belongs to VINOR KING 254701157072, Don't resell this script, because that will cause the bugs to be fixed quickly
